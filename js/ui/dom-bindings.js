...
const originStoryPromptContext = document.querySelector("#origin-story-prompt-context");
const originStoryPromptText = document.querySelector("#origin-story-prompt-text");
